use solana_nostd_entrypoint::{NoStdAccountInfo, Ref};
...
impl Mint {
    ...
    /// the account data.
    #[inline]
    pub fn from_account_info(account_info: &NoStdAccountInfo) -> Result<Ref<Mint>, ProgramError> {
    ...
    pub unsafe fn from_account_info_unchecked(
        ...
        Ok(Self::from_bytes(account_info.unchecked_borrow_data()))
    }
